        ...
        <x-app-layout>
            ...
            <div class="music-player">
                ...
                <div class="tab-buttons">
                    <button class="tab-button-mp3" data-track="vocals">
                        Vocals
                    </button>
                    <button class="tab-button-mp3" data-track="organ">
                        Organ
                    </button>
                    <button class="tab-button-mp3" data-track="preludes">
                        Preludes
                    </button>
                </div>
