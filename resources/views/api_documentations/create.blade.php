{{-- resources/views/api_documentations/create.blade.php --}}
...
<x-app-layout>
    ...
    <form action="{{ route('api_documentations.store') }}" method="POST">
        @csrf
        <div class="form-group">
            <label for="endpoint">Endpoint</label>
            <input type="text" name="endpoint" id="endpoint" class="form-control" required>
        </div>
        <div class="form-group">
